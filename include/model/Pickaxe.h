...
{
    public:
        PX_Strategy_Wood(float power = 1.0,int nbOresCraft = 10,EnumPickaxe ep = EnumPickaxe::PX_WOOD);
...
{
    public:
        PX_Strategy_Stone(float power = 1.7,int nbOresCraft = nbOres,EnumPickaxe ep = EnumPickaxe::PX_STONE);
        virtual bool isBreakable(EnumBlock typeBlock);
...
{
    public:
        PX_Strategy_Iron(float power = 2.5,int nbOresCraft = nbOres, EnumPickaxe ep = EnumPickaxe::PX_IRON);
        virtual bool isBreakable(EnumBlock typeBlock);
...
{
    public:
        PX_Strategy_Gold(float power = 3.3,int nbOresCraft = nbOres, EnumPickaxe ep = EnumPickaxe::PX_GOLD);
        virtual bool isBreakable(EnumBlock typeBlock);
...
{
    public:
        PX_Strategy_Diamond(float power = 5.0,int nbOresCraft = nbOres, EnumPickaxe ep = EnumPickaxe::PX_DIAMOND);        virtual bool isBreakable(EnumBlock typeBlock);
...
{
    public:
        PX_Strategy_Emerald(float power = 9.0,int nbOresCraft = nbOres, EnumPickaxe ep = EnumPickaxe::PX_EMERALD);
        virtual bool isBreakable(EnumBlock typeBlock);
